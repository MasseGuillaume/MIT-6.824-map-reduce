...
# start multiple workers.
timeout -k 2s 180s ../mrworker ../apps/early-exit.jar EarlyExit 0 3 &
timeout -k 2s 180s ../mrworker ../apps/early-exit.jar EarlyExit 1 3 &
timeout -k 2s 180s ../mrworker ../apps/early-exit.jar EarlyExit 2 3 &
